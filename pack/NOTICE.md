...
The repository and the generated `.mrpack` do not contain third-party mod JARs. Launchers or `tools/modpack.py materialize` fetch the exact unmodified artifacts from the upstream URLs recorded in `mods.lock.json` and verify their hashes.

| Artifact | Version | Role | License | Upstream |
|---|---|---|---|---|
| Goblin Traders | 1.12.0 | requested | MIT | [GitHub](https://github.com/MrCrayfish/GoblinTraders/releases/tag/v1.12.0%2B26.2) |
| Reconnectible Chains | 1.2.6 | replacement | LGPL-3.0-or-later | [Modrinth](https://modrinth.com/mod/reconnectible-chains/version/nwIizN1Z) |
| Eating Animation Fork | 2.1.0 | replacement | MIT | [Modrinth](https://modrinth.com/mod/eating-animation-fork/version/KDPMyXXY) |
| Falling Leaves | 2.0.7 | requested | MIT | [Modrinth](https://modrinth.com/mod/fallingleaves/version/JYRSvzQW) |
| Just Enough Items | 30.15.0.121 | requested | MIT | [Modrinth](https://modrinth.com/mod/jei/version/wdzSdTUD) |
| Mouse Tweaks | 2.31 | requested | BSD-3-Clause | [Modrinth](https://modrinth.com/mod/mouse-tweaks/version/jOiTBIaB) |
...
| Resourceful Lib | 5.0.3 | dependency | MIT | [Modrinth](https://modrinth.com/mod/resourceful-lib/version/SmfwDCLg) |
| Framework | 0.13.26 | dependency | LGPL-2.1 | [GitHub](https://github.com/MrCrayfish/Framework/releases/tag/v0.13.26%2B26.2) |

Minecraft is a trademark of Microsoft. Fabric, Prism Launcher, Modrinth, the individual mods, and their assets belong to their respective authors.
